    ...
    render(){
        return (
            <nav className="tabs">
                ...
                <NavLink className="tab" to="/category">分类</NavLink>
                <NavLink className="tab" to="/favorited">收藏</NavLink>
...
const tabsData = [
    ...
    {id: 2, title: '分类', path: '/category', badge: '',
    ...
    {id: 3, title: '收藏', path: '/favorited', badge: '',
